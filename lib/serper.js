...
// unavailable(detail) -> UpstreamError(503). Every failure mode (missing
// key, network error, any non-2xx upstream response — including exhausted
// credit balance) collapses to the SAME clean 503, never a 500 and never a
// leaked provider error message.
